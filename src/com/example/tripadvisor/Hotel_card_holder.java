...
public class Hotel_card_holder extends RecyclerView.Adapter<Hotel_card_holder.ViewHolder> {
	
	static int[] newdelhi={R.drawable.hotel_bright,R.drawable.emerald,R.drawable.palace_heights,R.drawable.check_in,R.drawable.corus,R.drawable.hans,R.drawable.radison,R.drawable.hotel_alka,R.drawable.janpath,R.drawable.hotel_delhi_regency};
	static String[] name;
	static String[] type;
...
//	static String[] fphotography;
    ...
    public Hotel_card_holder(int alength,String state1,String[] name1,String[] type1, int rowLayout, Context context) {
        name = name1;
        type = type1;
     //   open_hrs = open_hrs1;
        mContext=context;
     ...
     //   public TextView activityfair;
       // public TextView activityphoto_fair;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            activityName = (TextView) itemView.findViewById(R.id.hotelName);
            activityImage = (ImageView)itemView.findViewById(R.id.hotel_Image);
            activityType = (TextView) itemView.findViewById(R.id.hotel_type);
      ...
      //      activityfair= (TextView) itemView.findViewById(R.id.fair_text);
       //     activityphoto_fair = (TextView) itemView.findViewById(R.id.photography_text);
		...
		public void onClick(View arg0) {
			...
			Intent i = new Intent(mContext,About_Hotel.class);
