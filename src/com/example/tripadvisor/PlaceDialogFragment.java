...
public class PlaceDialogFragment extends DialogFragment{
	...
	public PlaceDialogFragment(DisplayMetrics dm){
		super();				
		this.mPlace = GlobalList.place1;
		this.mMetrics  = dm;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(mPlace!=null){
			...
			String key = "key=AIzaSyAbhl6HsWRtSSyPot-58p6i6YeXsHUNY6I";
